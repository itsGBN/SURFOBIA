...
public class TutorialAnimations : MonoBehaviour
{
    ...
    [SerializeField] bool isUsingHud;
    [SerializeField] bool isUsingParticles;
        ...
        if (!isGrounded)
        {
            if (isHolding && trickInput.y > 0.5f)
            {
                ...
                if (totalBodyRotation > comboThreshold)
                {
                    ...
                    if (isUsingHud) tutorialHud.GetComponent<TextMeshProUGUI>().text = "Front Flip!";
                    if(isUsingParticles) perfectTrick.Play();
            ...
            if (isHolding && trickInput.y < -0.5f)
            {
                ...
                if (totalBodyRotation < -comboThreshold)
                {
                    ...
                    if (isUsingHud) tutorialHud.GetComponent<TextMeshProUGUI>().text = "Back Flip!";
                    if(isUsingParticles) perfectTrick.Play();
            ...
            if (trickInput.x > 0.5f || isTurningRight)
            {
                ...
                if (isHolding)
                {
                    ...
                    if (totalRotation > comboThreshold)
                    {
                        ...
                        if (isUsingHud) tutorialHud.GetComponent<TextMeshProUGUI>().text = "Grab Spin!";
                        if(isUsingParticles) goodTrick.Play();
                ...
                else
                {
                    ...
                    if (totalRotation > comboThreshold)
                    {
                        ...
                        if (isUsingHud) tutorialHud.GetComponent<TextMeshProUGUI>().text = "Ray Spin!";
                        if (isUsingParticles) badTrick.Play();
